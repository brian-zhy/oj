...
.back-link a { color: #e74c3c; font-size: 14px; cursor: pointer; text-decoration: none; }
...
.title-row h1 { color: #e74c3c; font-size: 24px; margin: 0; }
...
.nav-btn.active { color: #e74c3c; }
.nav-btn.active::after { background: #e74c3c; width: 100%; left: 0; transform: translateX(0); }
...
.role-tag.admin { color: #e74c3c; background: #fef0ef; }
...
.btn-danger-outline { background: none; color: #e74c3c; border: none; font-size: 13px; cursor: pointer; }
...
.checkbox-label input { accent-color: #e74c3c; }
