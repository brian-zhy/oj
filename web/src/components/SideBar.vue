...
const isActive = (path: string) => {
  // 精确匹配：主页、用户管理、陶片放逐（避免 /judgement/admins 误高亮 /judgement）
  if (path === '/' || path === '/admin/user' || path === '/judgement') {
    ...
    <div class="nav-group nav-group--extra">
      ...
      <ul>
        <li>
          ...
          >
            <span class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Free 6.7.2 --><path d="M547.6 103.8L490.4 41c-4.5-4.8-10.8-7.5-17.4-7.5L55.2 33.3c-16.6 0-24.4 20.4-12.1 31.7L107.8 125 32.9 199.8c-12.2 11.7-6.6 31.6 10 34.4l41.2 6.9L48.9 302.4c-6.5 18.4 5.9 37.9 25.4 39.8L96 344.6l0 71.4c0 30.3 24.5 54.8 54.8 54.8l82.4 0 64 64c12.5 12.5 32.8 12.5 45.3 0l64-64 82.4 0c30.3 0 54.8-24.5 54.8-54.8l0-71.4 21.7-2.6c19.5-1.9 31.9-21.4 25.4-39.8l-35.2-61.7 41.2-6.9c16.6-2.8 22.2-22.7 10-34.4L420.2 125l64.7-60c12.3-11.3 4.5-31.7-12.1-31.7l-405 0c-6.6 0-12.9 2.7-17.4 7.5l-7.8 8.3zM288 112l58.6 59.4c6.2 6.3 6.1 16.4-.2 22.6L288 250.8 229.6 194c-6.2-6.3-6.1-16.4.2-22.6L288 112zM176 368l-16 0 32-64 32 32-32 32-16 0zm112 32l32-64 32 32-32 64-32-32zm96 32l32-64 32 32-32 64-32-32z"/></svg>
            </span>
            <span class="nav-text">经验商店</span>
          </a>
        </li>
        <li>
          <a
    ...
    <div class="nav-group nav-group--extra">
      ...
      <ul>
        ...
        <li>
          <a
            class="nav-item"
            :class="{ 'active': isActive('/judgement/admins') }"
            href="/judgement/admins"
            @click.prevent="navigateTo('/judgement/admins')"
          >
            <span class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2024 Fonticons, Inc. --><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>
            </span>
            <span class="nav-text">管理名单</span>
          </a>
        </li>
